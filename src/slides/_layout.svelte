...
<style lang="scss">
  ...
  :global {
    ...
    body:not(.theme_light) {
      ...
      --activity-bar0-shadow: 1px 1px 16px 0px rgba(112, 102, 94, 0.2) inset, -1px 0px 2px 0px rgba(255, 255, 255, 0.2) inset;
      ...
      --activity-bar1-shadow: 2px 2px 10px 0px rgba(93, 116, 141, 0.6) inset, -1px 0px 1px 0px rgba(255, 255, 255, 0.2) inset;
      ...
      --activity-bar2-shadow: 2px 2px 10px 0px rgba(242, 159, 13, 0.2) inset, -1px 1px 1px 0px rgba(255, 255, 255, 0.2) inset;
      --activity-bar3-bg: radial-gradient(2258.03% 620.37% at 83.33% 88.95%, #201502 0%, #C7830A 100%);
      --activity-bar3-shadow: 2px 2px 10px 0px rgba(242, 159, 13, 0.9) inset, -1px 1px 1px 0px rgba(255, 255, 255, 0.2) inset;
    ...
    body.theme_light {
      ...
      --activity-bar0-shadow: 1px 1px 16px 0px rgba(106, 106, 106, .2) inset, -1px 0px 2px 0px rgba(250, 250, 250, .2) inset;
      --activity-bar1-bg: radial-gradient(2408.25% 2730.55% at 89.06% 78.28%, rgba(250, 250, 250, 0.8) 0%, rgba(250, 250, 250, 0.8) 100%);
      --activity-bar1-shadow: 1px 1px 16px 0px rgba(106, 106, 106, .3) inset, -1px 0px 2px 0px rgba(250, 250, 250, .2) inset;
      --activity-bar2-bg: radial-gradient(68.1% 68.1% at 4.41% 31.9%, #FFF6DD 8.72%, #FFFEFA 100%);
      --activity-bar2-shadow: 0px 0px 20px 0px rgba(255, 176, 57, 0.4) inset, -1px 1px 1px 0px rgba(255, 255, 255, 0.5) inset;
      --activity-bar3-bg: radial-gradient(66.02% 86.49% at -16.18% 13.51%, rgba(255, 186, 6, 0.85) 0%, #FFF2AD 100%);
      --activity-bar3-shadow: 0px 0px 20px 0px rgba(255, 176, 57, 0.4) inset, -1px 1px 1px 0px rgba(255, 255, 255, 0.5) inset;
    ...
    body.theme_light .dark-only {
      display: none;
    }

    body:not(.theme_light) .light-only {
      display: none;
    }
